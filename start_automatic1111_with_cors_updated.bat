...
set AUTOMATIC1111_DIR=C:\Users\Luda\stable-diffusion-webui
...
REM Start Automatic1111 with CORS enabled for all ports
echo Starting Automatic1111 with CORS enabled for all ports...
call webui-user.bat --api --cors-allow-origins=http://localhost:8080,http://localhost:8081,http://localhost:8082,http://localhost:3000,http://127.0.0.1:8080,http://127.0.0.1:8081,http://127.0.0.1:8082,http://127.0.0.1:3000
